        ...
        <div className="container">
          <div className="footer__newsletter-content">
            <div className="footer__newsletter-text">
              <h2 className="footer__newsletter-title">Inscreva-se na nossa newsletter</h2>
          ...
          <div className="footer__content">
            ...
            <div className="footer__brand">
              <div className="footer__logo">
                <span className="footer__logo-ec">ec</span>
                <span className="footer__logo-onverse">onverse</span>
              </div>
            ...
            <div className="footer__links">
              <div className="footer__column">
                ...
                <ul className="footer__list">
                  ...
                  <li><a href="#" className="footer__link">Trabalhe conosco</a></li>
                </ul>
              </div>
              ...
              <div className="footer__column">
                ...
                <ul className="footer__list">
                  ...
                  <li><a href="#" className="footer__link">Fale Conosco</a></li>
              ...
              <div className="footer__column">
                ...
                <ul className="footer__list">
                  ...
                  <li><a href="#" className="footer__link">Trocas e Devoluções</a></li>
                </ul>
              </div>
            </div>
          </div>
